...
// Para obtener la IP del visitante
	...
	public  function locateIp(){
				...
				$data= array(
						'ip'				=>	$ip,
						'ciudad'			=>	$geodata['geoplugin_city'], 			
						'estado'			=>	$geodata['geoplugin_region'] ,			
						'pais'				=>	$geodata['geoplugin_countryName'],				
						'codigopais'		=>	$geodata['geoplugin_countryCode'],			
						'codigocontinente'	=>	$geodata['geoplugin_continentCode'], 
						'latitud'			=>	$geodata['geoplugin_latitude'] ,			
						'longitud'			=>	$geodata['geoplugin_longitude'],			
						'codigomoneda'		=>	$geodata['geoplugin_currencyCode'],
						'simbolomoneda'		=>	$geodata['geoplugin_currencySymbol'], 	
					//	'simbolomonedautf8'	=>	$geodata['geoplugin_currencySymbol_UTF8'],
						'dispositivo'	    =>	$dispositivo,
...
// Obtiene la informaci�n y la muestra
// en un json

}


$foo = new geo_info_api();
$foo->locateIp();
?>